...
<html>
	...
	<body>
		...
		<span class = "d-flex d-inline-flex mb-2">
			...
			<button type="button" class="btn btn-primary btn-md ml-5" data-toggle="modal" data-target="#modal1">Cadastrar Pessoa</button>
						...
						<div class="modal-header">
			      		...
			      		<div class="modal-body">
							...
							<form class = "form-group mt-2" action="cadastraPessoa.php" method="post">
								...
								<div class="form-group">
									<label for="internacoes">Internacoes:</label>
								...
								<div class="form-group">
									<label for="queixaprinc">Queixa Principal:</label>
				...
				<tbody id = "tbodyCadastro">
					...
					?>
						<tr>
							...
							<td><a class="btn btn-warning btn-sm" style="color:#fff" href="editacadastro.php?id=<?php echo $id_pessoa ?>" role="button"><i class="far fa-edit"></i></a></td>
         </tr>
